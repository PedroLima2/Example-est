...
namespace Examples.Charge.API.Controllers
{
    ...
    [ApiController]
    public class PhoneNumberTypeController : BaseController<PhoneNumberTypeDto>
    {
        ...
        [HttpPost]
        public IActionResult Post([FromBody] PhoneNumberTypeDto request)
        {
        ...
        [HttpPut]
        public IActionResult Put(int id, [FromBody] PhoneNumberTypeDto request)
        {
            if (id != request.PhoneNumberTypeID)
            {
