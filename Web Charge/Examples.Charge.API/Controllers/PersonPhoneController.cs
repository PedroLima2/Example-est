...
namespace Examples.Charge.API.Controllers
{
    ...
    [ApiController]
    public class PersonPhoneController : BaseController<PersonPhoneDto>
    {
        ...
        [HttpPost]
        public IActionResult Post([FromBody] PersonPhoneDto request)
        {
        ...
        [HttpPut]
        public IActionResult Put(int id, [FromBody] PersonPhoneDto request)
        {
